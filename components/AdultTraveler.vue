<template>
  ...
  <div class="form-container">
    ...
    <div class="formgrid grid my-2 border-1 border-gray-300 border-round-sm m-0" style="padding: 15px;">
      ...
      <DateOfBirthdayField v-model="passengerDetails.fields['date_of_birth']" :initialDate="traveler_b" />
...
const props = defineProps(["traveler", "modelValue", "index"]);
