<template>
  <div class="field col-12 md:col-6">
    <label><b>Passport Expiration Date</b> <span class="text-red-600" v-if="!selectedDate">*</span></label>
    <div class="flex">
      <div class="col-12">
        <Calendar 
      v-bind="attrs" v-model="selectedDate" :pt="calendarClasses" showButtonBar  showIcon dateFormat="M d, yy" :minDate="today"/>
      <span class="text-xs">Your passport should be valid for the entire duration of the trip.</span>
...
// ✅ Ahora aceptamos también initialDate
...
// ✅ Emitimos la fecha cuando cambia
watch(selectedDate, (newValue) => {
  emit('update:modelValue', formatDate(newValue));
});

// ✅ Si llega una fecha inicial, la aplicamos
watch(
  () => props.initialDate,
  (newVal) => {
    if (newVal) {
