...
<template>
<Toast />
  <template v-if="duffelOfferSelected" lass="duffelOfferSelected">
    <div class="flex flex-wrap mb-3">
      <!-- first column -->
      <div class="col-12 lg:col-8 p-0">
        <div class="border-1 border-gray-300 border-round-sm background_color_green">
            ...
            <div class="mb-4 mt-2">
              <div class="flex justify-content-between ml-3 my-3">
                <div class="text-sm text-gray-600">
                  <span v-tooltip.top="duffelOfferSelected.id">{{ formatOutboundDate(slice.segments[0].departing_at)
                    }}</span>
                  <span v-if="index === 0"> • Outbound</span>
                  <span v-if="index === duffelOfferSelected.slices.length - 1"> • Inbound</span>
                </div>
      ...
      <div class="col-12 lg:col-4 py-0 lg:pr-0 lg:pl-2 px-0 flex">
        <div class="border-1 border-gray-300 border-round-sm align-content-center background_color_green"
          style="width: -webkit-fill-available">
          <div class="flex flex-column my-3 lg:my-0">
            
			<!-- button -->
            <button class="font-interstate bg-bluegray-300 text-white mx-auto border-round mb-3 py-2 text-lg"
              style="width: 90%; cursor: default;">
              Selected
            </button> 
			  
            <!-- price 		  
            <p class="font-semibold text-xl green-vibe mx-auto mb-3">
              {{ $currencyDecimal(props.totalPriceProps) }}
              ...
              <AccordionTab :pt="accordionTabPToptions">
                ...
                <template #header>
                  <div class="flex text-sm mx-auto my-2">
                    <span class="style: familiy-font: interstate !important mr-2 included_word">Included: </span>
                ...
                <table class="text-sm mx-2">
                  ...
                  <tr>
                    ...
                    <td><span>{{ baggageCarryOnAllowedComputed }}</span>x Cabin item</td>
                    <td><i class="pi pi-check mx-1 text-green-vibe"></i>Included</td>
                  </tr>
                  <!-- checked baggage -->
                  <tr>
                    ...
                    <td><span>{{ baggageCheckedAllowedComputed }}</span>x Checked item</td>
                  </tr>
                </table>
              </AccordionTab>
            </Accordion>
...
const props = defineProps(['duffelOfferSelected', 'totalPriceProps']);
